...
public final class ActivityFrmConfigPageBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityFrmConfigPageBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ActivityFrmConfigPageBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityFrmConfigPageBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_frm_config_page, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityFrmConfigPageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityFrmConfigPageBinding((ConstraintLayout) rootView, btnConfig, btnDisponivel,
